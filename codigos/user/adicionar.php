...
if (isset($_FILES["foto"]) && isset($_POST['dia']) && isset($_POST['mes']) && isset($_POST['ano']) && isset($_POST['marca']) && isset($_POST['modelo']) && isset($_POST['chassi']) && isset($_POST['placa']) && isset($_POST['endereco']) && isset($_POST['servico_prestado'])) {
  ...
  if (verificarDATA($_POST['dia'], $_POST['mes'], $_POST['ano'])) {
    ...
    if (($aux1 != '' && verificaUsername($aux1) || $aux1 == '') && ($aux2 != '' && verificaUsername($aux2) || $aux2 == '') && ($aux3 != '' && verificaUsername($aux3) || $aux3 == '')) {
      ...
      if ($fotoPath !== false) {
        ...
        $stmt = $mysqli->prepare("INSERT INTO `servicos` (`username`, `imagem`, `data`, `marca`, `modelo`, `chassi`, `placa`, `endereco`, `servico_prestado`, `aux1`, `aux2`, `aux3`) VALUES ('$_SESSION[username]', '$fotoPath','$data', '$marca', '$modelo', '$chassi', '$placa', '$endereco', '$servico_prestado', '$aux1', '$aux2', '$aux3')");
        if ($stmt == false) {
          die("Erro na preparação: " . $mysqli->error);
        }
        $stmt->execute();
  ...
  <section class="hero-site">
    <div class="interface">
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          <form method="POST" action="" class="needs-validation" enctype="multipart/form-data" data-page-id="adicionar" novalidate>
