...
function verificaUsername($username)
{
  ...
  if ($result->num_rows > 0) {
    ...
    $mensagem[] = "Usuário não cadastrado no sistema. Verifique os valores dos campos auxiliares e Username.";
    return false;
  }
...
if (isset($_POST['alterar_btn'])) {
  ...
  if (isset($_POST['username']) && isset($_POST['dia']) && isset($_POST['mes']) && isset($_POST['ano']) && isset($_POST['marca']) && isset($_POST['modelo']) && isset($_POST['chassi']) && isset($_POST['placa']) && isset($_POST['endereco']) && isset($_POST['servico_prestado'])) {
    ...
    if (verificarDATA($_POST['dia'], $_POST['mes'], $_POST['ano'])) {
      ...
      if (($aux1 != '' && verificaUsername($aux1) || $aux1 == '') && ($aux2 != '' && verificaUsername($aux2) || $aux2 == '') && ($aux3 != '' && verificaUsername($aux3) || $aux3 == '') && verificaUsername($username)) {
        ...
        if (isset($_FILES["foto"]) && deleteimg()) {
          ...
          if ($fotoPath != false) {
            $stmt = $mysqli->prepare("UPDATE `servicos` SET `username`='$username',`imagem`='$fotoPath',`data`='$data',`marca`='$marca',`modelo`='$modelo',`chassi`='$chassi',`placa`='$placa',`endereco`='$endereco',`servico_prestado`='$servico_prestado',`aux1`='$aux1',`aux2`='$aux2',`aux3`='$aux3' WHERE `ID_servico`= '$ID_servico'");
          }
        } else {
          $stmt = $mysqli->prepare("UPDATE `servicos` SET `username`='$username',`data`='$data',`marca`='$marca',`modelo`='$modelo',`chassi`='$chassi',`placa`='$placa',`endereco`='$endereco',`servico_prestado`='$servico_prestado',`aux1`='$aux1',`aux2`='$aux2',`aux3`='$aux3' WHERE `ID_servico`= '$ID_servico'");
        }
        ...
        if ($stmt->affected_rows > 0) {
          $_SESSION['sucesso'] = 1;
          header('Location: ./ADMmenuEditar.php');
          exit();
        } else {
            ...
            <div class="d-flex flex-column mb-3">
              ...
              <div class="p-2">
                ...
                <div class="input-group" id="username">
                  ...
                  <input type="text" class="form-control" id="username" name="username" value="<?php echo $servico['username']; ?>" required>
                </div>
              </div>
